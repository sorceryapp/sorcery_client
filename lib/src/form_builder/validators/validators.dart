...
class FormBuilderValidators {
  ...
  static FormFieldValidator<T> required<T>({
    ...
    return (T? valueCandidate) {
      if (valueCandidate == null ||
        ...
        return errorText ?? SorceryLocalizations.current.requiredErrorText;
      }
      return null;
    };
  }
  ...
  static FormFieldValidator<T> equal<T>(
    ...
    String? errorText,
      ...
      (valueCandidate) => valueCandidate != value
          ? errorText ?? SorceryLocalizations.current.equalErrorText(value)
          : null;
  ...
  static FormFieldValidator<T> notEqual<T>(
    ...
    String? errorText,
      ...
      (valueCandidate) => valueCandidate == value
          ? errorText ?? SorceryLocalizations.current.notEqualErrorText(value)
          : null;
    ...
    return (T? valueCandidate) {
      if (valueCandidate != null) {
        ...
        if (number != null && (inclusive ? number < min : number <= min)) {
          return errorText ?? SorceryLocalizations.current.minErrorText(min);
        }
      }
      return null;
    };
    ...
    return (T? valueCandidate) {
      if (valueCandidate != null) {
        ...
        if (number != null && (inclusive ? number > max : number >= max)) {
          return errorText ?? SorceryLocalizations.current.maxErrorText(max);
        }
      }
      return null;
    };
  ...
  static FormFieldValidator<T> minLength<T>(
    ...
    return (T? valueCandidate) {
      ...
      return valueLength < minLength && (!allowEmpty || valueLength > 0)
          ? errorText ??
              SorceryLocalizations.current.minLengthErrorText(minLength)
          : null;
    };
  }
  ...
  static FormFieldValidator<T> maxLength<T>(
    ...
    return (T? valueCandidate) {
      ...
      return null != valueCandidate && valueLength > maxLength
          ? errorText ??
              SorceryLocalizations.current.maxLengthErrorText(maxLength)
          : null;
    };
  }
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          (valueCandidate?.isNotEmpty ?? false) && !isEmail(valueCandidate!)
              ? errorText ?? SorceryLocalizations.current.emailErrorText
              : null;
  ...
  static FormFieldValidator<String> url({
    ...
    List<String> hostBlacklist = const [],
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? SorceryLocalizations.current.urlErrorText
          : null;
  ...
  static FormFieldValidator<String> match(
    ...
    String? errorText,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? SorceryLocalizations.current.matchErrorText
          : null;
  ...
  static FormFieldValidator<String> numeric({
    String? errorText,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? SorceryLocalizations.current.numericErrorText
          : null;
  ...
  static FormFieldValidator<String> integer({
    ...
    int? radix,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? SorceryLocalizations.current.integerErrorText
          : null;
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          true == valueCandidate?.isNotEmpty && !isCreditCard(valueCandidate!)
              ? errorText ?? SorceryLocalizations.current.creditCardErrorText
              : null;
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          true == valueCandidate?.isNotEmpty && !isIP(valueCandidate!, version)
              ? errorText ?? SorceryLocalizations.current.ipErrorText
              : null;
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          true == valueCandidate?.isNotEmpty && !isDate(valueCandidate!)
              ? errorText ?? SorceryLocalizations.current.dateStringErrorText
              : null;
}
